                        ...
                        <div className="w-1/3 bg-white p-6 rounded-lg ">
                            ...
                            {announcements && announcements.length > 0 ? (
                                announcements.map((announcement, index) => {
                                    const description = announcement.description.split(" ").slice(0, 10).join(" "); 
                                    return (
                                        <div key={index} className="mb-4 p-4 bg-gray-50 rounded-lg shadow-sm border border-greenstat">
                                            ...
                                            <p className="font-poppins text-tertiary text-sm mb-2">{description}{description.length < announcement.description.length ? '...' : ''}</p> 
                                ...
                                <p className="font-poppins text-tertiary text-sm">Tidak ada pengumuman yang dipublikasikan saat ini.</p>
                            )}
